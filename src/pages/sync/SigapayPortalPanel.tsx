  ...
  return (
    <section className="form-card">
      ...
      <p className="field__hint">
        Consulta ACT/avisos em tempo real no site (requer sessão na secção <strong>Sessão</strong>{" "}
        acima ou em Sync → Dados do veículo). Use antes do sync para ver o que o portal devolve.
      </p>
