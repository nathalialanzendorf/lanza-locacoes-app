...
import { useClientes, useLocacoes, useVeiculos } from "@/api/hooks";
...
export function MovimentacaoListSection() {
  ...
  const temFiltro = Boolean(
    veiculoId || categoria || clienteId || periodoPreenchido(periodo),
  );
  ...
  const loadingExtra = clientesQuery.isLoading || veiculosQuery.isLoading;
      ...
      <section className="form-card">
        ...
        <div className="form-grid">
          ...
          <label className="field">
            ...
            <VeiculoSelect value={veiculoId} onChange={setVeiculoId} valueField="id" variant="filtro" />
          </label>
          <label className="field">
        ...
        columns={[
          {
            key: "cliente",
            header: "Cliente",
            sortValue: (l) => clienteDaLocacao(l),
            render: (l) => clienteDaLocacao(l),
          },
          {
            key: "placa",
            header: "Placa",
            sortValue: (l) => formatPlaca(l.placa),
            render: (l) => <strong>{formatPlaca(l.placa)}</strong>,
          },
          {
            key: "marcaModelo",
            header: "Marca / modelo",
